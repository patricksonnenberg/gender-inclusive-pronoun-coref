...
class Stanford:
    def get_corefs(self, sentence):
        """
        This method runs a sentence through the CoreNLP server to obtain
        the coreferences present in each sentence. A list of these
        ...
        # Sends POST request to CoreNLP server
    ...
    def compare_results(self, input_file):
        """
        This method gets the predicted coreferents for each sentence and
         compares them to the actual gold coreferents. They are both added
         to a new file as well, and this method counts the correct number
         of predictions for each gender/pronoun.
        """
        sentence_count = 0
...
if __name__ == "__main__":
    compare = Stanford().compare_results("new_sentences_updated.tsv")
